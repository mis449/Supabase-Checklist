...
import { fetchDelegation_DoneDataSortByDate, fetchDelegationDataSortByDate, updateDelegationTask } from "../api/delegationApi";
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(updateDelegationTask.fulfilled, (state, action) => {
        ...
        if (updatedTask) {
          state.delegation = state.delegation.map(task => 
