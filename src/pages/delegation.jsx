                        ...
                        return (
                          <Fragment key={index}>
                            ...
                            <td className="px-2 sm:px-6 py-2 sm:py-4 min-w-[200px] max-w-[300px]">
                              <div
                                className="text-xs sm:text-sm text-gray-900 whitespace-normal break-words leading-relaxed group relative"
                              >
                                ...
                                {!showHistory && userRole.toLowerCase() === 'admin' && (
                                  <button 
                                    onClick={() => handleOpenEditModal(task)}
                                    className="absolute -top-2 -right-2 p-1.5 bg-white shadow-md border border-gray-100 rounded-full text-blue-600 hover:text-blue-700 opacity-0 group-hover:opacity-100 transition-opacity z-10"
      ...
      />
       ...
       {isEditModalOpen && (
         <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
           ...
           />
           <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in-95 duration-200 border border-white/50">
             <div className="bg-gradient-to-r from-blue-600 to-indigo-600 px-6 py-4 flex justify-between items-center">
               <h3 className="text-white font-bold text-lg">Edit Task Description</h3>
               <button 
             ...
             <div className="p-6 space-y-4">
               <div className="space-y-2">
                 ...
                 <textarea
                   ...
                   className="w-full h-40 px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all resize-none text-sm leading-relaxed"
               ...
               <div className="flex justify-end gap-3 pt-2">
                 ...
                 <button
                   ...
                   disabled={isUpdating || !editedDescription.trim() || editedDescription === taskToEdit?.task_description}
                   className="px-6 py-2.5 bg-blue-600 text-white text-sm font-bold rounded-xl shadow-lg shadow-blue-200 hover:bg-blue-700 disabled:opacity-50 disabled:shadow-none transition-all flex items-center gap-2"
                 >
                   {isUpdating ? (
                     <>
